...
public:
    ...
    void SetSameRatioWithSprite(bool _b) { m_bSameRatioWithSprite = _b; }
    bool IsIgnoreParentScale() { return m_bIgnoreParentScale;}
    bool IsSameRatioWithSprite() { return m_bSameRatioWithSprite;}
